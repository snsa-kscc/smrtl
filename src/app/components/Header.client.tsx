        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden lg:block">
            <div className="ml-4 flex items-center lg:ml-6">
              ...
              <Link
                href={header.cta?.url ?? ''}
                className="bg-smartellDarkBlue hover:bg-smartellDarkBlue/90 ml-4 cursor-pointer rounded-full px-8 py-4 font-bold text-white shadow-xs transition duration-200"
              >
                {header.cta?.label}
              </Link>
            </div>
