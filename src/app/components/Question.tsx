...
export function Question({
  ...
  return (
    <div className="from-smartellDarkBlue to-smartellDarkBlue/85 bg-gradient-to-b px-4 py-10 sm:px-6 sm:py-16 md:px-12 md:py-20 lg:px-24 lg:py-24 xl:px-32">
      <h2 className="xl:text-10xl text-smartellLightPurple mb-8 px-2 text-center text-5xl font-bold text-balance sm:mb-12 sm:px-6 sm:pt-10 sm:text-6xl md:mb-16 md:px-10 md:pt-16 md:text-8xl lg:mb-20 lg:pt-20 lg:text-9xl">
        {title}
      </h2>
